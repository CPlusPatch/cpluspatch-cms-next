...
function Main({ posts, user, isAdmin }) {
	return (
		<div className="bg-gray-50 darkfalse:bg-[#020918] font-['Exo_2'] w-full min-h-screen duration-200">
			<Head>
...
function Header({ isAdmin }) {
	...
	const createNewPost = async () => {
		setButtonContents(
			<svg role="status" className="w-4 h-4 text-gray-200 animate-spin darkfalse:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	return (
		<div className="items-center justify-between block pt-6 pb-8 space-y-2 md:flex md:space-y-5">
			<div>
				<h1 className="text-3xl font-extrabold leading-9 tracking-tight text-gray-900 sm:text-4xl sm:leading-10 md:text-6xl md:leading-14">Recent publications</h1>
				<p className="mt-2 text-lg leading-7 text-gray-800">The latest crap written directly served to you by the wonderful invention called the Internet</p>
			</div>
			<div>
				{isAdmin && (
