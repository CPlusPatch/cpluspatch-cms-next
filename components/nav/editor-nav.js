					...
					<div className="px-2 mx-auto max-w-7xl sm:px-4 lg:px-8">
						<div className="flex justify-between h-16">
							<div className="flex px-2 lg:px-0">
								...
								<button onClick={() => {if (!isSaving) onSave();}} type="button" className="w-24 h-9 inline-flex justify-center items-center px-3 py-1.5 text-sm font-medium leading-4 text-indigo-700 bg-indigo-100 border border-transparent rounded-md hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
									{isSaving ? <>
										...
										</svg> <span className="mb-0.5">Saving...</span>
									</> : <>
										<ServerIcon className="w-4 h-4 mr-2"/> <span className="mb-0.5">Save</span>
									</>}
								</button>
								</div>
							</div>
